...
export default function StudentClassrooms() {
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      <h1 className="text-2xl font-bold text-foreground mb-6">Мои классы</h1>

      {classrooms.length === 0 ? (
        <div className="text-center py-16">
          <div className="text-5xl mb-4">📖</div>
          <h2 className="text-lg font-medium text-foreground mb-2">Нет классов</h2>
          <p className="text-muted-foreground mb-4">Найдите класс чтобы начать обучение</p>
          <Link href="/student/search"><Button>Найти класс</Button></Link>
        </div>
      ) : (
