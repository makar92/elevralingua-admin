...
export const SCENE_OPTIONS: SceneOption[] = [
  ...
  { id: "restaurant", emoji: "🍜", label: "Restaurant", gradient: "from-[oklch(0.22_0.03_30)] to-[oklch(0.18_0.02_20)]" },
  { id: "school", emoji: "🏫", label: "School", gradient: "from-[oklch(0.22_0.03_250)] to-[oklch(0.18_0.02_240)]" },
  { id: "shop", emoji: "🛒", label: "Shop", gradient: "from-[oklch(0.22_0.025_140)] to-[oklch(0.18_0.02_150)]" },
  { id: "home", emoji: "🏠", label: "Home", gradient: "from-[oklch(0.23_0.02_60)] to-[oklch(0.18_0.015_50)]" },
  { id: "park", emoji: "🌳", label: "Park", gradient: "from-[oklch(0.22_0.035_145)] to-[oklch(0.18_0.025_135)]" },
  { id: "office", emoji: "🏢", label: "Office", gradient: "from-[oklch(0.22_0.015_250)] to-[oklch(0.18_0.01_260)]" },
  { id: "airport", emoji: "✈️", label: "Airport", gradient: "from-[oklch(0.22_0.02_220)] to-[oklch(0.18_0.015_230)]" },
  { id: "hospital", emoji: "🏥", label: "Hospital", gradient: "from-[oklch(0.22_0.02_190)] to-[oklch(0.18_0.015_200)]" },
  { id: "market", emoji: "🏪", label: "Market", gradient: "from-[oklch(0.23_0.03_50)] to-[oklch(0.18_0.025_40)]" },
  { id: "transport", emoji: "🚌", label: "Transport", gradient: "from-[oklch(0.22_0.025_270)] to-[oklch(0.18_0.02_280)]" },
  { id: "hotel", emoji: "🏨", label: "Hotel", gradient: "from-[oklch(0.23_0.02_300)] to-[oklch(0.18_0.015_310)]" },
  { id: "cafe", emoji: "☕", label: "Cafe", gradient: "from-[oklch(0.23_0.03_45)] to-[oklch(0.18_0.02_35)]" },
  { id: "bank", emoji: "🏦", label: "Bank", gradient: "from-[oklch(0.22_0.015_260)] to-[oklch(0.18_0.01_270)]" },
  { id: "gym", emoji: "🏋️", label: "Gym", gradient: "from-[oklch(0.22_0.025_25)] to-[oklch(0.18_0.02_15)]" },
  { id: "cinema", emoji: "🎬", label: "Cinema", gradient: "from-[oklch(0.20_0.02_320)] to-[oklch(0.16_0.015_330)]" },
];
