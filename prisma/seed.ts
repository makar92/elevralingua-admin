...
async function main() {
  ...
  await prisma.contentBlock.createMany({ data: [
    ...
    { sectionId: s1_1_1.id, type: "VOCAB_CARD", order: 1, contentJson: { hanzi: "你好", pinyin: "nǐ hǎo", translation: "hello", audioUrl: "https://translate.google.com/translate_tts?ie=UTF-8&tl=zh-CN&client=tw-ob&q=%E4%BD%A0%E5%A5%BD", exampleHanzi: "你好！我叫小明。", examplePinyin: "Nǐ hǎo! Wǒ jiào Xiǎo Míng.", exampleTranslation: "Hello! My name is Xiao Ming." } },
    { sectionId: s1_1_1.id, type: "VOCAB_CARD", order: 2, contentJson: { hanzi: "我", pinyin: "wǒ", translation: "I, me", audioUrl: "https://translate.google.com/translate_tts?ie=UTF-8&tl=zh-CN&client=tw-ob&q=%E6%88%91", exampleHanzi: "我是学生。", examplePinyin: "Wǒ shì xuéshēng.", exampleTranslation: "I am a student." } },
    { sectionId: s1_1_1.id, type: "VOCAB_CARD", order: 3, contentJson: { hanzi: "你", pinyin: "nǐ", translation: "you", audioUrl: "https://translate.google.com/translate_tts?ie=UTF-8&tl=zh-CN&client=tw-ob&q=%E4%BD%A0", exampleHanzi: "你叫什么名字？", examplePinyin: "Nǐ jiào shénme míngzì?", exampleTranslation: "What is your name?" } },
    { sectionId: s1_1_1.id, type: "VOCAB_CARD", order: 4, contentJson: { hanzi: "是", pinyin: "shì", translation: "to be", audioUrl: "https://translate.google.com/translate_tts?ie=UTF-8&tl=zh-CN&client=tw-ob&q=%E6%98%AF", exampleHanzi: "我是老师。", examplePinyin: "Wǒ shì lǎoshī.", exampleTranslation: "I am a teacher." } },
    { sectionId: s1_1_1.id, type: "VOCAB_CARD", order: 5, contentJson: { hanzi: "叫", pinyin: "jiào", translation: "to be called", audioUrl: "https://translate.google.com/translate_tts?ie=UTF-8&tl=zh-CN&client=tw-ob&q=%E5%8F%AB", exampleHanzi: "我叫大卫。", examplePinyin: "Wǒ jiào Dàwèi.", exampleTranslation: "My name is David." } },
  ] });
  ...
  const exercises1_1 = [
    ...
    { sectionId: s1_1_1.id, exerciseType: "TONE_PLACEMENT", order: 2, title: "Расставь тоны: 你好", instructionText: "Add the correct tone marks to the pinyin.", difficulty: 2, gradingType: "AUTO", isDefaultInWorkbook: true, correctAnswers: ["nǐ hǎo"], contentJson: { characters: [{ hanzi: "你", pinyin: "ni", tones: { 0: "3" } }, { hanzi: "好", pinyin: "hao", tones: { 0: "3" } }] } },
    { sectionId: s1_1_1.id, exerciseType: "WORD_ORDER", order: 3, title: "Составь предложение", instructionText: "Put the words in the correct order.", difficulty: 2, gradingType: "TEACHER", isDefaultInWorkbook: true, correctAnswers: ["我叫大卫。"], contentJson: { words: ["叫", "我", "大卫", "。"], correctOrder: "我叫大卫。", translation: "My name is David." } },
    ...
    { sectionId: s1_1_3.id, exerciseType: "DICTATION", order: 7, title: "Диктант: диалог", instructionText: "Listen and write in Chinese characters.", difficulty: 3, gradingType: "TEACHER", isDefaultInWorkbook: true, referenceAnswer: "你好！我叫李明。", contentJson: { correctText: "你好！我叫李明。", audioUrl: "https://translate.google.com/translate_tts?ie=UTF-8&tl=zh-CN&client=tw-ob&q=%E4%BD%A0%E5%A5%BD%EF%BC%81%E6%88%91%E5%8F%AB%E6%9D%8E%E6%98%8E%E3%80%82" } },
  ...
  await prisma.contentBlock.createMany({ data: [
    { sectionId: s1_2_1.id, type: "VOCAB_CARD", order: 0, contentJson: { hanzi: "再见", pinyin: "zàijiàn", translation: "goodbye", audioUrl: "https://translate.google.com/translate_tts?ie=UTF-8&tl=zh-CN&client=tw-ob&q=%E5%86%8D%E8%A7%81", exampleHanzi: "老师再见！", examplePinyin: "Lǎoshī zàijiàn!", exampleTranslation: "Goodbye, teacher!" } },
    { sectionId: s1_2_1.id, type: "VOCAB_CARD", order: 1, contentJson: { hanzi: "谢谢", pinyin: "xièxie", translation: "thank you", audioUrl: "https://translate.google.com/translate_tts?ie=UTF-8&tl=zh-CN&client=tw-ob&q=%E8%B0%A2%E8%B0%A2", exampleHanzi: "谢谢你！", examplePinyin: "Xièxie nǐ!", exampleTranslation: "Thank you!" } },
    { sectionId: s1_2_1.id, type: "VOCAB_CARD", order: 2, contentJson: { hanzi: "不客气", pinyin: "bú kèqi", translation: "you're welcome", audioUrl: "https://translate.google.com/translate_tts?ie=UTF-8&tl=zh-CN&client=tw-ob&q=%E4%B8%8D%E5%AE%A2%E6%B0%94", exampleHanzi: "不客气！", examplePinyin: "Bú kèqi!", exampleTranslation: "You're welcome!" } },
    { sectionId: s1_2_1.id, type: "VOCAB_CARD", order: 3, contentJson: { hanzi: "对不起", pinyin: "duìbuqǐ", translation: "sorry", audioUrl: "https://translate.google.com/translate_tts?ie=UTF-8&tl=zh-CN&client=tw-ob&q=%E5%AF%B9%E4%B8%8D%E8%B5%B7", exampleHanzi: "对不起，我迟到了。", examplePinyin: "Duìbuqǐ, wǒ chídào le.", exampleTranslation: "Sorry, I'm late." } },
    { sectionId: s1_2_1.id, type: "VOCAB_CARD", order: 4, contentJson: { hanzi: "没关系", pinyin: "méi guānxi", translation: "it's OK", audioUrl: "https://translate.google.com/translate_tts?ie=UTF-8&tl=zh-CN&client=tw-ob&q=%E6%B2%A1%E5%85%B3%E7%B3%BB", exampleHanzi: "没关系！", examplePinyin: "Méi guānxi!", exampleTranslation: "It's OK!" } },
  ] });
  ...
  await prisma.exercise.createMany({ data: [
    ...
    { sectionId: s1_2_2.id, exerciseType: "WORD_ORDER", order: 2, title: "Составь: Спасибо, учитель!", instructionText: "Arrange words correctly.", difficulty: 2, gradingType: "TEACHER", isDefaultInWorkbook: true, correctAnswers: ["谢谢老师！"], contentJson: { words: ["老师", "谢谢", "！"], correctOrder: "谢谢老师！" } },
  ...
  await prisma.contentBlock.createMany({ data: [
    { sectionId: s1_3_1.id, type: "VOCAB_CARD", order: 0, contentJson: { hanzi: "吗", pinyin: "ma", translation: "question particle", audioUrl: "https://translate.google.com/translate_tts?ie=UTF-8&tl=zh-CN&client=tw-ob&q=%E5%90%97", exampleHanzi: "你好吗？", examplePinyin: "Nǐ hǎo ma?", exampleTranslation: "How are you?" } },
    { sectionId: s1_3_1.id, type: "VOCAB_CARD", order: 1, contentJson: { hanzi: "很", pinyin: "hěn", translation: "very", audioUrl: "https://translate.google.com/translate_tts?ie=UTF-8&tl=zh-CN&client=tw-ob&q=%E5%BE%88", exampleHanzi: "我很好。", examplePinyin: "Wǒ hěn hǎo.", exampleTranslation: "I'm very good." } },
    { sectionId: s1_3_1.id, type: "VOCAB_CARD", order: 2, contentJson: { hanzi: "好", pinyin: "hǎo", translation: "good", audioUrl: "https://translate.google.com/translate_tts?ie=UTF-8&tl=zh-CN&client=tw-ob&q=%E5%A5%BD", exampleHanzi: "很好！", examplePinyin: "Hěn hǎo!", exampleTranslation: "Very good!" } },
    { sectionId: s1_3_1.id, type: "VOCAB_CARD", order: 3, contentJson: { hanzi: "呢", pinyin: "ne", translation: "and you?", audioUrl: "https://translate.google.com/translate_tts?ie=UTF-8&tl=zh-CN&client=tw-ob&q=%E5%91%A2", exampleHanzi: "你呢？", examplePinyin: "Nǐ ne?", exampleTranslation: "And you?" } },
  ] });
  ...
  await prisma.exercise.createMany({ data: [
    ...
    { sectionId: s2_1_1.id, exerciseType: "TONE_PLACEMENT", order: 2, title: "Тоны чисел", instructionText: "Add tone marks.", difficulty: 2, gradingType: "AUTO", isDefaultInWorkbook: true, correctAnswers: ["yī èr sān"], contentJson: { characters: [{ hanzi: "一", pinyin: "yi", tones: { 0: "1" } }, { hanzi: "二", pinyin: "er", tones: { 0: "4" } }, { hanzi: "三", pinyin: "san", tones: { 0: "1" } }] } },
  ...
  await prisma.exercise.createMany({ data: [
    ...
    { sectionId: s2_3_2.id, exerciseType: "WORD_ORDER", order: 1, title: "Сколько стоит?", instructionText: "Arrange words.", difficulty: 2, gradingType: "TEACHER", isDefaultInWorkbook: true, correctAnswers: ["这个多少钱？"], contentJson: { words: ["多少", "这个", "钱", "？"], correctOrder: "这个多少钱？" } },
